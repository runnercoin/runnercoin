...
// everywhere (and called just CSecret); in the current Runnercoin implementation it is only used for
...
// Note: Runnercoin implementation uses a hack: CSecret32 is used here, everywhere else
