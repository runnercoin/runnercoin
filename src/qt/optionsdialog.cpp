...
void OptionsDialog::setModel(OptionsModel *model)
{
    ...
    /* update the display unit, to not use the default ("RUC") */
    updateDisplayUnit();
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Runnercoin."), QMessageBox::Ok);
