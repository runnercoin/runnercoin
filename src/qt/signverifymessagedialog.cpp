    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a Runnercoin address (e.g. HVguPy1tWgbu9cKy6YGYEJFJ6RD7z7F7MJ)"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a Runnercoin address (e.g. HVguPy1tWgbu9cKy6YGYEJFJ6RD7z7F7MJ)"));
    ui->signatureIn_VM->setPlaceholderText(tr("Enter Runnercoin signature"));
#endif
