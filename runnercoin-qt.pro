TEMPLATE = app
TARGET = runnercoin-qt
macx:TARGET = "RunnerCoin-Qt"
VERSION = 1.0.05
...
RUNNERCOIN_HEADERS = headers.h strlcpy.h serialize.h uint256.h util.h key.h bignum.h base58.h scrypt.h \
...
HEADERS += $$join(RUNNERCOIN_HEADERS, " src/", " src/",)
SOURCES += $$join(RUNNERCOIN_SOURCES, " src/", " src/",)
...
TRANSLATIONS = $$files(src/qt/locale/runnercoin_*.ts)
...
macx:ICON = src/qt/res/icons/runnercoin.icns
